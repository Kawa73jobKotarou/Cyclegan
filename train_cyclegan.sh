...
python train.py --dataroot ./datasets/241004_allbody_fullset --name 250621_patch192_BoneGene_0.5patch_241004_allbody_fullset --model cycleSesim_extention --crop_patch_size 192 --batch_size 16 --pool_size 50 --no_dropout --dataset_mode dicom_extention --original_size 365 --make_patch --input_nc 5 --output_nc 5 --load_size 256 --learned_attn --lambda_spatial 10.0 --lambda_perceptual 0.1 --lambda_style 0.1 --use_CTloss --lambda_CT 1.0 --serial_batches
