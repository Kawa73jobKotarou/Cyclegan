...
python train.py --dataroot ./datasets/241004_allbody_fullset --name 2505021_hayashi_0.5patch_241004_allbody_fullset --model hayashi --pool_size 50 --no_dropout --dataset_mode dicom --original_size 365 --crop_patch_size 128 --make_patch --input_nc 5 --output_nc 5 --load_size 256 --lambda_style 0.1
