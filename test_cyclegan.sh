...
python test.py --dataroot ./datasets/241004_allbody_fullset --name 250612_patch64_Boneextention_0.5patch_241004_allbody_fullset --model cycleSesim_extention --phase test --no_dropout --load_size 256 --dataset_mode dicom_extention --input_nc 5 --output_nc 5
