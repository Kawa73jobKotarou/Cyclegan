...
# python test.py --dataroot ./datasets/241004_allbody_fullset --name 250627_patch192_Bonemask_0.5patch_241004_allbody_fullset --model cycle_LSeSim --dataset_mode dicom_extention --phase test --no_dropout --load_size 256 --input_nc 5 --output_nc 5
